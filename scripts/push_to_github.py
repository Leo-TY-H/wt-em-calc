...
def main():
    ...
    parser.add_argument('--message', default='Update calculator and game data')
    ...
    run(sys.executable, 'scripts/sync_game_data.py', '--force')
    run(sys.executable, 'scripts/update_pages_snapshot.py', '--offline')
    run('git', 'add', '--all')
